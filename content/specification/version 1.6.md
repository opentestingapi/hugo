...
<a href="../OpenTestApiSchema_v1.6.json">[Download JSON Schema Specification 1.6]</a>
...
conversion | String | convert existing data to new data target type: int (we might add more target types on demand)
...
#RANDOMVALUE4# will be the result of #RANDOMVALUE3# as Integer value.
